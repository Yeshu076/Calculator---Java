...
public class Calculator {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 259, 433);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().setLayout(null);
		
		textField = new JTextField();
		textField.setBounds(12, 42, 230, 43);
		...
		button_BS.setBounds(14, 96, 50, 50);
		button_BS.setFont(new Font("Tahoma", Font.BOLD, 15));
		...
		button_Percent.setBounds(130, 96, 50, 50);
		button_Percent.setFont(new Font("Tahoma", Font.BOLD, 15));
		...
		button_Plus.setBounds(190, 97, 50, 50);
		...
		btnButton7.setBounds(12, 156, 50, 50);
		btnButton7.setFont(new Font("Tahoma", Font.BOLD, 24));
		...
		button8.setBounds(69, 156, 50, 50);
		...
		button_9.setBounds(130, 157, 50, 50);
		...
		button_Minus.setBounds(190, 157, 50, 50);
		...
		button_4.setBounds(12, 218, 50, 50);
		...
		button_5.setBounds(69, 218, 50, 50);
		...
		button_6.setBounds(130, 218, 50, 50);
		...
		button_Mult.setBounds(190, 218, 50, 50);
		button_Mult.setFont(new Font("Tahoma", Font.BOLD, 24));
		...
		button_1.setBounds(12, 278, 50, 50);
		...
		button_2.setBounds(67, 278, 50, 50);
		...
		button_3.setBounds(128, 279, 50, 50);
		...
		button_Divide.setBounds(188, 278, 50, 50);
		button_Divide.setFont(new Font("Tahoma", Font.BOLD, 24));
		...
		button_0.setBounds(12, 339, 50, 50);
		button_0.setFont(new Font("Tahoma", Font.BOLD, 24));
		frame.getContentPane().add(button_0);
		
		//**This button is for the symbol "."
		JButton button_Dot = new JButton(".");
		button_Dot.setBounds(67, 339, 50, 50);
		...
		button_PM.setBounds(128, 340, 50, 50);
		button_PM.setFont(new Font("Tahoma", Font.BOLD, 15));
		...
		button_Equal.setBounds(188, 341, 50, 50);
